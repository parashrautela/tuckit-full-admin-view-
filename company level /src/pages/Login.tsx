...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-screen flex items-center justify-center bg-[#F9FAFB] p-4 text-zinc-900">
      <Card className="w-full max-w-[420px] shadow-sm border border-zinc-200 rounded-xl bg-white p-2">
        {/* Card Header matching reference Image 2 */}
        <CardHeader className="pb-4">
          ...
          <CardDescription className="text-xs text-zinc-500 mt-1">
            Enter your credentials below to access the management console
          </CardDescription>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2.5 pt-2">
              ...
              <Button
                ...
                onClick={() => {
                  setUsername('parash');
                  setPassword('Tuckit@200');
                }}
                className="w-full h-10 border-zinc-200 bg-white hover:bg-zinc-50 text-zinc-800 font-medium text-sm rounded-lg"
              >
